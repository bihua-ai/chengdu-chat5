...
export function ChatRoom({ roomId }: ChatRoomProps) {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#F5F5F5] max-w-[100vw] overflow-hidden">
        ...
        {messages.map((message) => (
          ...
          >
            ...
            >
              ...
              <div className="break-words mt-1 text-sm sm:text-base">
                {message.content}
              </div>
            </div>
          </div>
      ...
      <form onSubmit={handleSend} className="bg-white border-t">
        <div className="p-2 sm:p-4 flex space-x-2">
          <textarea
            ...
            className="flex-1 resize-none outline-none focus:outline-none p-2 bg-white text-sm sm:text-base"
            placeholder="输入消息..."
          />
          <button
            type="submit"
            className="self-end inline-flex items-center px-3 py-2 sm:px-4 sm:py-2 border border-gray-200 rounded-md shadow-sm text-sm font-medium bg-[#E9E9E9] hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
          >
